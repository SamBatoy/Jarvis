...
export default function LoadingState({ label }) {
  return (
    <p className="flex items-center gap-2 font-mono text-xs uppercase tracking-wider text-hud-muted" role="status">
      <svg className="h-3.5 w-3.5 shrink-0 animate-spin text-hud-accent" viewBox="0 0 24 24" fill="none" aria-hidden="true">
